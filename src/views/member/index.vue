  ...
  <div class="dashboard-container" @click="showMore=false">
    <div class="filter-container">
      <ul>
        <li class="panelLi">
          <span>所属村民小组：</span>
          <el-select v-model="listQuery.village" size="small" clearable style="width: 90px" class="filter-item">
            <el-option v-for="item in 0" :key="item" :label="item" :value="item" />
          </el-select>
        </li>
        <li class="panelLi">
          <span>年龄：</span>
          <el-select v-model="listQuery.age" size="small" clearable style="width: 90px" class="filter-item">
            <el-option v-for="item in 0" :key="item" :label="item" :value="item" />
          </el-select>
        </li>
      </ul>
      <ul>
        <li class="search">
          <el-input v-model="listQuery.searchVal" size="small" placeholder="成员姓名/居民身份证号">
            <el-button slot="append">搜索</el-button>
            <!-- 高级弹窗 -->
            <el-popover slot="append" width="301" placement="bottom-end" trigger="click" class="senior">
              <el-button slot="reference">高级</el-button>
              <ul>
                <li>
                  <span>所属小组名</span>：
                  <el-select v-model="listQuery.village" size="small" clearable style="width: 185px" class="filter-item">
                    <el-option v-for="item in 0" :key="item" :label="item" :value="item" />
                  </el-select>
                </li>
                <li>
                ...
                <li>
                  <span>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄</span>：
                  <el-input v-model="listQuery.searchVal" size="small" style="width:80px" />
                  <span style="display:inline-block;margin:0 2px">至</span>
                  <el-input v-model="listQuery.searchVal" size="small" style="width:80px" />
                </li>
                <li>
                  <span>家庭成员数</span>：
